...
const DialogContent = React.forwardRef(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        // Base
        'fixed z-50 bg-background shadow-lg border duration-300',
        // Mobile: bottom sheet — slide up from bottom
        'inset-x-0 bottom-0 top-auto rounded-t-2xl p-5 w-full',
        'data-[state=open]:animate-in data-[state=closed]:animate-out',
        'data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom',
        // Desktop: centered modal
        'sm:bottom-auto sm:left-[50%] sm:top-[50%] sm:inset-x-auto sm:w-full sm:max-w-lg',
